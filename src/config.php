...
return [
    ...
    'size_limit' => 3840,// Максимальный размер одной из сторон изображения для хранения в кэше. По умолчанию 2X Full HD (3840 px)
    'def_min_size_limit' => 500,// Минимальный размер px одной из сторон изображения "по умолчанию" для хранения в кэше.
    'default_min_size' => 1500, //Максимальный размер px одной из сторон изображения "по умолчанию" для хранения в кэше.
    'default_mobile_min_size' => 1000,// Максимальный размер px для мобильных устройств одной из сторон изображения "по умолчанию" для хранения в кэше.
];