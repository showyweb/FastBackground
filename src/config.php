...
return [
    ...
    'relative_path_for_cache' => '/.fast_background', //Относительный путь от корневой директории сайта до директории кэша изображений. Файлы в этой директории должны иметь публичный доступ для скачивания по протоколу HTTP
